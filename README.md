...
and also [let's inspect the assembly output](https://godbolt.org/#g:!((g:!((g:!((h:codeEditor,i:(filename:'1',fontScale:14,fontUsePx:'0',j:1,lang:c%2B%2B,selection:(endColumn:2,endLineNumber:39,positionColumn:2,positionLineNumber:39,selectionStartColumn:2,selectionStartLineNumber:39,startColumn:2,startLineNumber:39),source:'%23include+%3Chttps://raw.githubusercontent.com/AVasK/some/refs/heads/main/some.hpp%3E%0A%0A%23include+%3Ccassert%3E%0A%23include+%3Ctype_traits%3E%0A%23include+%3Cfunctional%3E%0A%0A//+simple+polymorphic+function+type%0A%0Atemplate+%3Ctypename+Signature%3E%0Astruct+Callable%3B%0A%0Atemplate+%3Ctypename+R,+typename...+Args%3E%0Astruct+Callable%3CR+(Args...)%3E+:+vx::trait+%7B%0A++++R+operator()+(Args...+args)+%7B%0A++++++++return+call(args...)%3B%0A++++%7D%0Aprivate:%0A++++virtual+R+call(Args...+args)+%3D+0%3B%0A%7D%3B%0A%0Atemplate+%3Ctypename+F,+typename+R,+typename...+Args%3E%0Astruct+vx::impl%3CCallable%3CR+(Args...)%3E,+F%3E+:+vx::impl_for%3CCallable%3CR+(Args...)%3E,+F%3E+%7B%0Ausing+vx::impl_for%3CCallable%3CR+(Args...)%3E,+F%3E::impl_for%3B+//+pulls+in+the+ctors%0A++++R+call(Args...+args)+override+%7B%0A++++++++return+vx::poly+%7Bthis%7D-%3Eoperator()(args...)%3B%0A++++%7D%0A%7D%3B%0A%0Aauto+call_some(vx::some%3CCallable%3Cint(int)%3E%3E+f)+%7B%0A++++return+f(42)%3B%0A%7D%0A%0Aauto+call_fsome(vx::fsome%3CCallable%3Cint(int)%3E%3E+f)+%7B%0A++++return+f(42)%3B%0A%7D%0A%0Aauto+call_std_function(std::function%3Cint(int)%3E+f)+%7B%0A++++return+f(42)%3B%0A%7D%0A%0Aint+main()+%7B%7D%0A'),l:'5',n:'0',o:'C%2B%2B+source+%231',t:'0')),k:48.002754820936644,l:'4',n:'0',o:'',s:0,t:'0'),(g:!((h:compiler,i:(compiler:gsnapshot,filters:(b:'0',binary:'1',binaryObject:'1',commentOnly:'0',debugCalls:'1',demangle:'0',directives:'0',execute:'0',intel:'0',libraryCode:'0',trim:'1',verboseDemangling:'0'),flagsViewOpen:'1',fontScale:14,fontUsePx:'0',j:1,lang:c%2B%2B,libs:!(),options:'-std%3Dc%2B%2B20+-O3',overrides:!(),selection:(endColumn:1,endLineNumber:1,positionColumn:1,positionLineNumber:1,selectionStartColumn:1,selectionStartLineNumber:1,startColumn:1,startLineNumber:1),source:1),l:'5',n:'0',o:'+x86-64+gcc+(trunk)+(Editor+%231)',t:'0')),k:43.87052341597796,l:'4',n:'0',o:'',s:0,t:'0'),(g:!((h:output,i:(compilerName:'x86-64+gcc+15.2',editorid:1,fontScale:14,fontUsePx:'0',j:1,wrap:'1'),l:'5',n:'0',o:'Output+of+x86-64+gcc+(trunk)+(Compiler+%231)',t:'0')),k:8.126721763085401,l:'4',n:'0',o:'',s:0,t:'0')),l:'2',n:'0',o:'',t:'0')),version:4)
